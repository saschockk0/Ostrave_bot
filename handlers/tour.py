...
# Карточки тура: атмосфера и план по дням, без цен и правил (это берёт на себя FAQ).
_CARDS = (
    (
        "🌊 <b>Берег Волги</b>\n\n"
    ...
    (
        "🏝 <b>План на три дня</b>\n\n"
        "Как всё будет — от заезда до последнего трека 👇\n\n"
        "🌲 <b>31 июля, пятница — заезд</b>\n"
        "⛺️ Приезжаем, ставим палатки, обживаем лагерь\n"
        "🚶 Знакомимся с островом: берег, тропы, костровые точки\n"
        "🌙 Вечером — «разминочная» ночная программа: мягко входим в ритм\n\n"
        "🌅 <b>1 августа, суббота — главный день</b>\n"
        "🚣 Днём — парусные катамараны и сап-борды на Волге\n"
        "🧖 Баня — с прыжком прямо в реку\n"
        "🌇 Встречаем закат на берегу…\n"
        "🎧 …и перебираемся в лес: отборная электроника от наших диджеев "
        "до самого утра\n\n"
        "🎒 <b>2 августа, воскресенье — выезд</b>\n"
        "☕️ Неспешное утро, кофе у костра\n"
